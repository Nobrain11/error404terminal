      ...
      <div style={{ padding: "12px 16px", flexShrink: 0 }}>
        {!address ? (
          <div style={{ background: S, border: `1px solid ${B}`, borderRadius: 14, padding: 16 }}>
            <div style={{ fontSize: 14, fontWeight: 700, marginBottom: 12 }}>Connect Wallet</div>
            <div style={{ fontSize: 12, color: T2, marginBottom: 10 }}>
              Enter your wallet address to view your portfolio on Robinhood Chain
            </div>
            <input
              value={inputAddr}
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "0 16px 100px", scrollbarWidth: "none" }}>
            ...
            {tab === "History" && (
              <div style={{ background: S, border: `1px solid ${B}`, borderRadius: 14, padding: 16, textAlign: "center" }}>
                ...
                <button
                  onClick={() => window.open(`https://explorer.robinhood.com/address/${address}`, "_blank")}
                  style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontWeight: 700, fontSize: 13 }}>
                        Connected Wallet <span style={{ fontSize: 10, color: G }}>● Active</span>
                      </div>
